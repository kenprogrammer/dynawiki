<?php
    ...
    if(isset($_GET['page'])){
        $page=clean_input($con,$_GET['page']).".php";
    }else{
        $page='dashboard.php';
    }
?>
...
<html>
  <head>
    ...
    <title>DynaWiki|Admin Panel</title>
     <!-- jQuery 2.1.4 -->
    <script src="../js/jQuery/jquery_2_2_4.js"></script>
    <!-- Bootstrap 3.3.5 -->
...
/*--This JavaScript method for Print Preview command--*/
    ...
    function PrintDoc() {
        ...
        popupWin.document.write('<html><title>::Print Preview::</title><link rel="stylesheet" type="text/css" href="lte/bootstrap/css/bootstrap.min.css" media="screen"/></head><body onload="window.print()">')
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index.php" class="logo">
          ...
          <span class="logo-lg"><b>DYNAWIKI-</b>WMS</span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="lte/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                    <p>
                      <?php echo $_SESSION['full_name'].'-'.$_SESSION['position']; ?>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?php echo date("Y"); ?> <a href="#">Ndunge Investments</a>.</strong> All rights reserved.
      </footer>
